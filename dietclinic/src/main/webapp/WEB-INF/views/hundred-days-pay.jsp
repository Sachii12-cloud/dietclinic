...
<header>
   ...
   <section class="container">
      <div class="login-container">
        <h1 class="login-title">Order Confirmation</h1>
      </div>
    </section>
     ...
     <div class="container1">
        ...
        <div class="cart-totals">
            <h2>Cart Totals</h2>
            <p>Sub Total: <span>Rs.10000</span></p>
            <p>Total: <span class="two">Rs.10000</span></p>
            <img src="https://th.bing.com/th/id/OIP.OQaQ2X-3XTeP8mLkqXxmrQHaKg?rs=1&pid=ImgDetMain" alt="">
        </div>
    </div>
